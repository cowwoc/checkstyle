...
package com.puppycrawl.tools.checkstyle.test.checks.naming;
...
public class RecordComponentNameCheckTest extends com.puppycrawl.tools.checkstyle.test.AbstractModuleTestSupport {
    ...
    public void testRecordDefault()
        ...
        verifyWithInlineConfigParser(
                getPath("InputRecordComponentNameDefault.java"), expected);
    }
    ...
    public void testClassFooName()
        ...
        verifyWithInlineConfigParser(
                getPath("InputRecordComponentNameLowercase.java"), expected);
    }
